...
if [ "$sgp_test" = "sgp.test <- TRUE" ]; then
	...
	pid=$!
	wait $pid
	cd ../Bureau_Indian_Affairs
	echo $sgp_test > BIA.R
	cat "./PARCC_BIA_SGP_2015_2016.2.R" >> BIA.R
	R CMD BATCH --vanilla BIA.R; mv ./BIA.Rout ./Logs/BIA.Rout; rm BIA.R &
	...
	wait $pid
	cd ../Bureau_Indian_Affairs
	R CMD BATCH --vanilla PARCC_BIA_SGP_2015_2016.2.R; mv ./PARCC_BIA_SGP_2015_2016.2.Rout ./Logs/PARCC_BIA_SGP_2015_2016.2.Rout
