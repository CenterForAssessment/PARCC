...
library(RSQLite)
library(data.table)
source('./Dropbox/Application_Projects/EOC Course progressions/courseProgressionSGP.R', chdir = TRUE)
...
math.prog <- courseProgressionSGP(PARCC_MATH, lag.direction.argument="BACKWARD", year='2015_2016_2')
...
sum(math.prog$BACKWARD[['2015_2016.2']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ALGEBRA_I.CT"]$COUNT)   # 104362
sum(math.prog$BACKWARD[['2015_2016.2']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ALGEBRA_II.CT"]$COUNT)  # 2981

	####  Untenable Progressions
sum(math.prog$BACKWARD[['2015_2016.2']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="GEOMETRY.CT"]$COUNT)    # 2323 (repeaters)
sum(math.prog$BACKWARD[['2015_2016.2']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="INTEGRATED_MATH_1.CT"]$COUNT) # 79
...
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_II.CT"]$COUNT) # 438 - no repeater analyses
...
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ALGEBRA_I.CT"]$COUNT) # 11705
	...
	####  Untenable Progressions
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ALGEBRA_II.CT"]$COUNT)  # 4324 (repeaters)
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="MATHEMATICS.08"]$COUNT) # 
...
sum(math.prog$BACKWARD[['2015_2016.2']]$INTEGRATED_MATH_1.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="GEOMETRY.CT"]$COUNT)   # 
sum(math.prog$BACKWARD[['2015_2016.2']]$INTEGRATED_MATH_1.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_I.CT"]$COUNT)  # 
sum(math.prog$BACKWARD[['2015_2016.2']]$INTEGRATED_MATH_1.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_II.CT"]$COUNT) # 
...
sum(math.prog$BACKWARD[['2015_2016.2']]$INTEGRATED_MATH_2.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="INTEGRATED_MATH_3.CT"]$COUNT) # 2
