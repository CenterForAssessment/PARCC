...
PARCC_Data_LONG_2016 <- rbindlist(list(
	read.parcc("CO", "D201606"), read.parcc("IL", "D201606"), 
	read.parcc("MD", "D201606"), read.parcc("MA", "D201606"), 
	read.parcc("NJ", "D201606"), read.parcc("NM", "D201606"),
	read.parcc("RI", "D201606"), read.parcc("DC", "D201606")))
...
PARCC_Data_LONG_2016[, c("a", "b", "SummativeCSEM") := NULL]

setnames(PARCC_Data_LONG_2016, c("IRTTheta", "SummativeScaleScore"), c("SCALE_SCORE", "SCALE_SCORE_ACTUAL"))
