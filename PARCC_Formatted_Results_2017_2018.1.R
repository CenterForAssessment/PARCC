################################################################################
###                                                                          ###
###         Format PARCC Fall 2017 Results Data to Return to Pearson         ###
###                                                                          ###
################################################################################
...
###
###    Read in Fall 2017 Output Files
###

load("./PARCC/Data/Archive/2017_2018.1/PARCC_SGP_LONG_Data_2017_2018.1.Rdata")

load("./Maryland/Data/Archive/2017_2018.1/Maryland_SGP_LONG_Data_2017_2018.1.Rdata")
load("./New_Jersey/Data/Archive/2017_2018.1/New_Jersey_SGP_LONG_Data_2017_2018.1.Rdata")
load("./New_Mexico/Data/Archive/2017_2018.1/New_Mexico_SGP_LONG_Data_2017_2018.1.Rdata")
load("./Bureau_Indian_Affairs/Data/Archive/2017_2018.1/_SGP_LONG_Data_2017_2018.1.Rdata") # outputSGP naming issue with BI

###  Amend State Files as needed
Bureau_Indian_Affairs_SGP_LONG_Data_2017_2018.1 <- `_SGP_LONG_Data_2017_2018.1`; rm(`_SGP_LONG_Data_2017_2018.1`) # outputSGP naming issue with BIA
...
State_LONG_Data <- rbindlist(list(
  Maryland_SGP_LONG_Data_2017_2018.1, New_Jersey_SGP_LONG_Data_2017_2018.1,
  New_Mexico_SGP_LONG_Data_2017_2018.1, Bureau_Indian_Affairs_SGP_LONG_Data_2017_2018.1), fill=TRUE)

####    Remove rows associated with the Scale Score SGP
State_LONG_Data <- State_LONG_Data[grep("_SS", CONTENT_AREA, invert =TRUE),]
PARCC_LONG_Data <- PARCC_SGP_LONG_Data_2017_2018.1[grep("_SS", CONTENT_AREA, invert =TRUE),]
...
# levels(PARCC_LONG_Data$SGPTargetTestCodePARCC) <- c("ALG01", "ALG02", "ELA", "GEO01", "MAT2I", "MAT") # Change MAT3I to MAT2I.  No INTEGRATED_MATH_3 analyses viable, so projections can only go to 2
...
save(FINAL_LONG_Data, file="./PARCC/Data/Pearson/PARCC_SGP_LONG_Data_2017_2018.1-FORMATTED.Rdata")
...
for (abv in sort(unique(FINAL_LONG_Data$StateAbbreviation))) {
  if (abv=="BI") tmp.state <- "Bureau Indian Affairs" else tmp.state <- SGP:::getStateAbbreviation(abv, type="state")
	fname <- paste0("PARCC_", abv, "_2017-2018_Fall_SGP-Results_", format(Sys.Date(), format="%Y%m%d"), ".csv")
