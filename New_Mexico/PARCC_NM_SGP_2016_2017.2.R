...
New_Mexico_SGP <- abcSGP(
		state="NM",
		sgp_object=fetchPARCC(state="NM", parcc.db = "../PARCC/Data/PARCC_Data_LONG.sqlite", prior.years=c("2015_2", "2016_1", "2016_2", "2017_1"), current.year="2017_2", fields="*"),
...
### Save results
if (sgp.test) {
	save(New_Mexico_SGP, file="./Data/SIM/New_Mexico_SGP-Test_PARCC_2016_2017.2.Rdata")
} else save(New_Mexico_SGP, file="./Data/Archive/2016_2017.2/New_Mexico_SGP.Rdata")
