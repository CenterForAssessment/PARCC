################################################################################
###                                                                          ###
###      SGP analysis script for PARCC New Mexico - Fall 2018 Analyses       ###
###                                                                          ###
################################################################################
...
###   Create Fall 2018 Archive for NM
...
table(New_Mexico_SGP@Data[, !is.na(SGP), as.character(SGP_NORM_GROUP)])
table(New_Mexico_SGP@Data[, !is.na(SGP_NOTE), as.character(SGP_NORM_GROUP)])


###   Save results  -- NO SGPs Produced, so don't save object.

# if (sgp.test) {
# 	save(New_Mexico_SGP, file="./Data/SIM/New_Mexico_SGP-Test_PARCC_2018_2019.1.Rdata")
# } else save(New_Mexico_SGP, file="./Data/Archive/2018_2019.1/New_Mexico_SGP.Rdata")
