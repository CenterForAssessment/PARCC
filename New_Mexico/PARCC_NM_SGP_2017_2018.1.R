...
###   Create Fall 2017 Archive for NM
...
New_Mexico_SGP <- abcSGP(
		...
		outputSGP.directory="../New_Mexico/Data/Archive/2017_2018.1",
...
# if (sgp.test) {
# 	save(New_Mexico_SGP, file="./Data/SIM/New_Mexico_SGP-Test_PARCC_2017_2018.1.Rdata")
# } else save(New_Mexico_SGP, file="./Data/Archive/2017_2018.1/New_Mexico_SGP.Rdata")
