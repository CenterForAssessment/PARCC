...
math.prog <- courseProgressionSGP(PARCC_MATH, lag.direction="BACKWARD", year='2016_2017.1')
ela.prog <- courseProgressionSGP(PARCC_ELA, lag.direction="BACKWARD", year='2016_2017.1')
...
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="MATHEMATICS.08"]$COUNT) # 3132
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="GEOMETRY.CT"]$COUNT) # 73
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_I.CT"]$COUNT) # 905 repeaters


math.prog$BACKWARD[['2016_2017.1']]$GEOMETRY.CT[COUNT>100]
sum(math.prog$BACKWARD[['2016_2017.1']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_I.CT"]$COUNT)  # 2615
sum(math.prog$BACKWARD[['2016_2017.1']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_II.CT"]$COUNT) # 582
sum(math.prog$BACKWARD[['2016_2017.1']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="GEOMETRY.CT"]$COUNT)   # 1012 (repeaters)


math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_II.CT[COUNT>100]
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="GEOMETRY.CT"]$COUNT) # 1884
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_I.CT"]$COUNT) # 699
sum(math.prog$BACKWARD[['2016_2017.1']]$ALGEBRA_II.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ALGEBRA_II.CT"]$COUNT) # 4877 (repeaters)
