###############################################################################
###                                                                         ###
###    Configs for Spring 2025 Grade Level Math Cohort and Baseline SGPs    ###
###                                                                         ###
###############################################################################
...
ALGEBRA_I.2025.config <- list(
    ...
    ALGEBRA_I.2025 = list(
        ...
        sgp.panel.years = c("2023_2024.2", "2024_2025.2"),
...
ALGEBRA_II.2025.config <- list(
    ### CANONICAL
    ALGEBRA_II.2025 = list(
    ...
    ALGEBRA_II.2025 = list( #  --  <1000 :: Include for SGP_NOTE
