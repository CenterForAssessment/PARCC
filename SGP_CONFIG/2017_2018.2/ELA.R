#####################################################################################
###                                                                               ###
###    SGP Configurations code for Spring 2018  Grade Level ELA - Theta SCORES    ###
###                                                                               ###
#####################################################################################

ELA.2017_2018.2.config <- list(
	...
	ELA.2017_2018.2 = list(  #  Skip year progression for Washington DC
