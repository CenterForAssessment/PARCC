################################################################################################
###                                                                                          ###
###   SGP Configurations for Spring 2018 Grade Level and EOCT Math subjects - Theta SCORES   ###
###                                                                                          ###
################################################################################################

PARCC.Math.Subjects <- c("GEOMETRY", "ALGEBRA_I", "ALGEBRA_II", "INTEGRATED_MATH_1", "INTEGRATED_MATH_2", "INTEGRATED_MATH_3")

MATHEMATICS.2017_2018.2.config <- list(
	MATHEMATICS.2017_2018.2 = list(
...
ALGEBRA_I.2017_2018.2.config <- list(
	...
	ALGEBRA_I.2017_2018.2 = list(
		...
		# sgp.exclude.sequences = data.table(VALID_CASE = "VALID_CASE", CONTENT_AREA="ALGEBRA_I",
	...
	ALGEBRA_I.2017_2018.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("GEOMETRY", "ALGEBRA_I"),
	...
	ALGEBRA_I.2017_2018.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
GEOMETRY.2017_2018.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	GEOMETRY.2017_2018.2 = list(
		sgp.content.areas=c("MATHEMATICS", "ALGEBRA_I", "GEOMETRY"),
		sgp.panel.years=c("2015_2016.2", "2016_2017.2", "2017_2018.2"),
		sgp.grade.sequences=list(c("8", "EOCT", "EOCT")),
		# sgp.exact.grade.progression=TRUE, #  NO exact - use to calculate "ALGEBRA_I", "GEOMETRY" matrices AND avoid duplicate projections (Thetas).
	...
	# GEOMETRY.2017_2018.2 = list( ##  NOT NEEDED if canonical progression run without exact above.
	...
	# 	sgp.norm.group.preference=2L),
	#
	GEOMETRY.2017_2018.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("ALGEBRA_I", "GEOMETRY"),
		sgp.panel.years=c("2017_2018.1", "2017_2018.2"),
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		sgp.projection.grade.sequences=list("NO_PROJECTIONS"),
	...
	GEOMETRY.2017_2018.2 = list(  #  Skip year progression for Washington DC
		sgp.content.areas=c("ALGEBRA_I", "GEOMETRY"),
	...
	GEOMETRY.2017_2018.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
ALGEBRA_II.2017_2018.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	ALGEBRA_II.2017_2018.2 = list(
	...
	ALGEBRA_II.2017_2018.2 = list( # Fall - Spring
	...
	ALGEBRA_II.2017_2018.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
	...
	ALGEBRA_II.2017_2018.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
INTEGRATED_MATH_1.2017_2018.2.config <- list(
...
INTEGRATED_MATH_2.2017_2018.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
...
INTEGRATED_MATH_3.2017_2018.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
