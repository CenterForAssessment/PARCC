#####################################################################################
###                                                                               ###
###              SGP Configurations for Fall 2017 EOCT Math subjects              ###
###                                                                               ###
#####################################################################################

PARCC.Math.Subjects <- c("GEOMETRY", "ALGEBRA_I", "ALGEBRA_II", "INTEGRATED_MATH_1", "INTEGRATED_MATH_2", "INTEGRATED_MATH_3")

ALGEBRA_I.2017_2018.1.config <- list(
	###   Grade Level Priors
	ALGEBRA_I.2017_2018.1 = list(
	...
	ALGEBRA_I.2017_2018.1 = list(  #  SGP_NOTE
	...
	ALGEBRA_I.2017_2018.1 = list( #  Fall to Fall period analyses  (Exclude those with ANY Spring math courses)  #  SGP_NOTE
		sgp.content.areas=c("GEOMETRY", "ALGEBRA_I"),
		sgp.panel.years=c("2016_2017.1", "2017_2018.1"),
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		sgp.exclude.sequences = data.table(VALID_CASE = "VALID_CASE", CONTENT_AREA=PARCC.Math.Subjects,
			YEAR="2016_2017.2", GRADE="EOCT"),  #  Leave exclusions for SGP_NOTE
		sgp.norm.group.preference=5,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS"))
)


GEOMETRY.2017_2018.1.config <- list(
	###   EOCT (Primary) Priors
	GEOMETRY.2017_2018.1 = list(
		...
		sgp.norm.group.preference=1,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	GEOMETRY.2017_2018.1 = list(  #  SGP_NOTE
	...
	GEOMETRY.2017_2018.1 = list(  #  SGP_NOTE
		...
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	GEOMETRY.2017_2018.1 = list(  #  Fall to Fall period analyses  #  SGP_NOTE
		sgp.content.areas=c("ALGEBRA_II", "GEOMETRY"),
		sgp.panel.years=c("2016_2017.1", "2017_2018.1"),
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		sgp.exclude.sequences = data.table(VALID_CASE = "VALID_CASE", CONTENT_AREA=PARCC.Math.Subjects,
...
ALGEBRA_II.2017_2018.1.config <- list(
	###   EOCT (Primary) Priors
	ALGEBRA_II.2017_2018.1 = list(
		sgp.content.areas=c("ALGEBRA_I", "GEOMETRY", "ALGEBRA_II"),
		sgp.panel.years=c("2015_2016.2", "2016_2017.2", "2017_2018.1"),
		sgp.grade.sequences=list(c("EOCT", "EOCT", "EOCT")),
		sgp.norm.group.preference=0,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	ALGEBRA_II.2017_2018.1 = list(  #  SGP_NOTE
	...
	ALGEBRA_II.2017_2018.1 = list(
		...
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		# sgp.exclude.sequences = data.table(VALID_CASE = "VALID_CASE", CONTENT_AREA=PARCC.Math.Subjects,
		# 	YEAR="2016_2017.2", GRADE="EOCT"),  #  Don't exclude anything from actual analyses (non-SGP_NOTE)
		sgp.norm.group.preference=6,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	ALGEBRA_II.2017_2018.1 = list(  #  SGP_NOTE
		sgp.content.areas=c("ALGEBRA_I", "ALGEBRA_II"),
