################################################################################################
###                                                                                          ###
###   SGP Configurations for Spring 2019 Grade Level and EOCT Math subjects - SCALE SCORES   ###
###                                                                                          ###
################################################################################################
...
MATHEMATICS_SS.2018_2019.2.config <- list(
	MATHEMATICS_SS.2018_2019.2 = list(
...
ALGEBRA_I_SS.2018_2019.2.config <- list(
	...
	ALGEBRA_I_SS.2018_2019.2 = list(
		...
		#   YEAR=c("2017_2018.1", "2018_2019.1"), GRADE="EOCT"),
	...
	ALGEBRA_I_SS.2018_2019.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("GEOMETRY_SS", "ALGEBRA_I_SS"),
	...
	ALGEBRA_I_SS.2018_2019.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
GEOMETRY_SS.2018_2019.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	GEOMETRY_SS.2018_2019.2 = list(
	...
	GEOMETRY_SS.2018_2019.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
...
ALGEBRA_II_SS.2018_2019.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	ALGEBRA_II_SS.2018_2019.2 = list(
	...
	ALGEBRA_II_SS.2018_2019.2 = list( # Fall - Spring
	...
	ALGEBRA_II_SS.2018_2019.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
	...
	ALGEBRA_II_SS.2018_2019.2 = list( #  --  <1000 :: Include for SGP_NOTE (except 9th grade)
	...
	ALGEBRA_II_SS.2018_2019.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
INTEGRATED_MATH_1_SS.2018_2019.2.config <- list(
...
INTEGRATED_MATH_2_SS.2018_2019.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
...
INTEGRATED_MATH_3_SS.2018_2019.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
