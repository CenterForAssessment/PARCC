...
ALGEBRA_I.2016_2017.2.config <- list(
	...
	ALGEBRA_I.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("GEOMETRY", "ALGEBRA_I"),
	...
	ALGEBRA_I.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
GEOMETRY.2016_2017.2.config <- list(
	...
	# GEOMETRY.2016_2017.2 = list( ##  NOT NEEDED if canonical progression run without exact above.
	...
	# 	sgp.norm.group.preference=2L),
	#
	GEOMETRY.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("ALGEBRA_I", "GEOMETRY"),
		sgp.panel.years=c("2016_2017.1", "2016_2017.2"),
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		sgp.projection.grade.sequences=list("NO_PROJECTIONS"),
	...
	GEOMETRY.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
ALGEBRA_II.2016_2017.2.config <- list(
	...
	ALGEBRA_II.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
	...
	ALGEBRA_II.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
INTEGRATED_MATH_2.2016_2017.2.config <- list(
	...
	INTEGRATED_MATH_2.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
	...
	INTEGRATED_MATH_2.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
...
INTEGRATED_MATH_3.2016_2017.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	INTEGRATED_MATH_3.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
