...
ALGEBRA_I_SS.2016_2017.2.config <- list(
	...
	ALGEBRA_I_SS.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("GEOMETRY_SS", "ALGEBRA_I_SS"),
...
GEOMETRY_SS.2016_2017.2.config <- list(
	...
	# GEOMETRY_SS.2016_2017.2 = list( ##  NOT NEEDED if canonical progression run without exact above.
	...
	# 	sgp.norm.group.preference=2L),
	#
	GEOMETRY_SS.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
		sgp.content.areas=c("ALGEBRA_I_SS", "GEOMETRY_SS"),
		sgp.panel.years=c("2016_2017.1", "2016_2017.2"),
		sgp.grade.sequences=list(c("EOCT", "EOCT")),
		sgp.projection.grade.sequences=list("NO_PROJECTIONS"),
...
ALGEBRA_II_SS.2016_2017.2.config <- list(
	### CANONICAL - Put first over Fall to Spring for projections/targets (Match Thetas analyses)
	ALGEBRA_II_SS.2016_2017.2 = list(
	...
	ALGEBRA_II_SS.2016_2017.2 = list( # Fall - Spring
	...
	ALGEBRA_II_SS.2016_2017.2 = list( # Fall - Spring  --  <1000 :: Include for SGP_NOTE
	...
	ALGEBRA_II_SS.2016_2017.2 = list( #  --  <1000 :: Include for SGP_NOTE
