################################################################################
###                                                                          ###
###            SGP Configurations for Fall 2019 EOCT Math subjects           ###
###                                                                          ###
################################################################################

PARCC.Math.Subjects <- c("GEOMETRY", "ALGEBRA_I", "ALGEBRA_II", "INTEGRATED_MATH_1", "INTEGRATED_MATH_2", "INTEGRATED_MATH_3")

ALGEBRA_I.2019_2020.1.config <- list(
	###   Grade Level Priors
	ALGEBRA_I.2019_2020.1 = list(
	...
	ALGEBRA_I.2019_2020.1 = list(  #  SGP_NOTE
	...
	ALGEBRA_I.2019_2020.1 = list( #  Fall to Fall period analyses  (Exclude those with ANY Spring math courses)  #  SGP_NOTE
		sgp.content.areas=c("GEOMETRY", "ALGEBRA_I"),
...
GEOMETRY.2019_2020.1.config <- list(
	###   EOCT (Primary) Priors
	GEOMETRY.2019_2020.1 = list(
		...
		sgp.norm.group.preference=1,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	GEOMETRY.2019_2020.1 = list(  #  SGP_NOTE
...
ALGEBRA_II.2019_2020.1.config <- list(
	###   EOCT (Primary) Priors
	ALGEBRA_II.2019_2020.1 = list(
		sgp.content.areas=c("ALGEBRA_I", "GEOMETRY", "ALGEBRA_II"),
		sgp.panel.years=c("2017_2018.2", "2018_2019.2", "2019_2020.1"),
		sgp.grade.sequences=list(c("EOCT", "EOCT", "EOCT")),
		sgp.norm.group.preference=0,
		sgp.projection.grade.sequences=list("NO_PROJECTIONS")),
	ALGEBRA_II.2019_2020.1 = list(  #  SGP_NOTE
	...
	###   Grade Level Priors
	ALGEBRA_II.2019_2020.1 = list(  #  SGP_NOTE   XXX  2019 No grade???  Leave for next year
