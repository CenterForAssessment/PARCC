################################################################################
###                                                                          ###
###   SGP analysis script for Bureau of Indian Affairs - Fall 2018 Analyses  ###
###                                                                          ###
################################################################################
...
###   Create Fall 2018 Archive for BI
...
table(Bureau_Indian_Affairs_SGP@Data[, !is.na(SGP), as.character(SGP_NORM_GROUP)])
table(Bureau_Indian_Affairs_SGP@Data[, !is.na(SGP_NOTE), as.character(SGP_NORM_GROUP)])


###   Save results  -- NO SGPs Produced, so don't save object.

# if (sgp.test) {
# 	save(Bureau_Indian_Affairs_SGP, file="./Data/SIM/Bureau_Indian_Affairs_SGP-Test_PARCC_2018_2019.1.Rdata")
# } else save(Bureau_Indian_Affairs_SGP, file="./Data/Archive/2018_2019.1/Bureau_Indian_Affairs_SGP.Rdata")
