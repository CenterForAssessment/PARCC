...
###   Read in Spring 2024 Output Files
for (org in c("Bureau_of_Indian_Education", "Department_Of_Defense",
              "Illinois", "New_Jersey", "Washington_DC", "PARCC")) {
    load(
        paste0(org, "/Data/Archive/2023_2024.2/",
               gsub("Of", "of", org), "_SGP_LONG_Data_2023_2024.2.Rdata")
    )
}
...
##    'NA' or <1000 per Pearson 2024 Growth File Layout v1
