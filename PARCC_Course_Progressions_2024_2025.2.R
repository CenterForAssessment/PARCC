################################################################################
###                                                                          ###
###               Identify Spring 2025 Progressions for PARCC                ###
###                                                                          ###
################################################################################
...
###   Load results data from 2024
# load("./Data/Archive/2022_2023.2/PARCC_SGP_LONG_Data_2022_2023.2.Rdata")
# load("./Data/Archive/2023_2024.2/PARCC_SGP_LONG_Data_2023_2024.2.Rdata")

# ###   Load cleaned 2025 LONG data
# load("../Illinois/Data/Archive/2024_2025.2/Illinois_Data_LONG_2024_2025.2.Rdata")
# load("../New_Jersey/Data/Archive/2024_2025.2/New_Jersey_Data_LONG_2024_2025.2.Rdata")
# load("../Department_Of_Defense/Data/Archive/2024_2025.2/Department_of_Defense_Data_LONG_2024_2025.2.Rdata")
# load("../Bureau_of_Indian_Education/Data/Archive/2024_2025.2/Bureau_of_Indian_Education_Data_LONG_2024_2025.2.Rdata")
# load("../Washington_DC/Data/Archive/2022_2023.2/Washington_DC_Data_LONG_2022_2023.2.Rdata")
# load("../Washington_DC/Data/Archive/2024_2025.2/Washington_DC_Data_LONG_2024_2025.2.Rdata")

# ##    See 2024 Growth layout -- BIE blank if not enrolled in 2023.
# ##    Now validate as their `StateStudentIdentifier` are non-null
# PARCC_SGP_LONG_Data_2023_2024.2[, VALID_CASE := "VALID_CASE"]

# ##    Combine prior data and cleaned 2025 data
# PARCC_Data_LONG <-
#     rbindlist(
#         list(
...
#             ],
#             PARCC_SGP_LONG_Data_2023_2024.2,
#             Illinois_Data_LONG_2024_2025.2,
#             New_Jersey_Data_LONG_2024_2025.2,
#             Department_of_Defense_Data_LONG_2024_2025.2,
...
###   Load prelim 2025 analysis data to check IDs and available progressions/orders
load("./Data/Archive/2024_2025.2/Bureau_of_Indian_Education_SGP_LONG_Data.Rdata")
PARCC_Data_LONG <- Bureau_of_Indian_Education_SGP_LONG_Data
...
# ##    See 2024 Growth layout -- Blank if not enrolled in 2023.
# ##    Now validate as their `StateStudentIdentifier` are non-null
# Bureau_of_Indian_Education_SGP_LONG_Data_2023_2024.2[, VALID_CASE := "VALID_CASE"]
...
# setnames(
#     PARCC_Data_LONG,
#     c("StateStudentIdentifier", "ID"), # 2025
#     c("ID", "PANUniqueStudentID")
# )

rm(list = grep("2023|2024_2025", ls(), value = TRUE)); gc()


###   Get subset of PARCC_Data_LONG with only IDs from Spring 2025
ids <- unique(PARCC_Data_LONG[YEAR=="2024_2025.2", ID])
...
table(Spring_Data_LONG[YEAR=="2024_2025.2", GRADE, CONTENT_AREA])
...
ela.prog <-
  courseProgressionSGP(
    ...
    lag.direction = "BACKWARD", year = "2024_2025.2"
  )
math.prog<-
  courseProgressionSGP(
    Spring_Data_LONG[!CONTENT_AREA %in% "ELA"],
...
names(math.prog$BACKWARD[["2024_2025.2"]])

###
###   Algebra I (No Repeaters or Regression)
###

ALG1 <- math.prog$BACKWARD[["2024_2025.2"]]$ALGEBRA_I.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1 != "ALGEBRA_I.EOCT" | is.na(CONTENT_AREA_by_GRADE_PRIOR_YEAR.1)] #  Keep NA's for Fall to Fall checks
...
###   Viable 1 Prior ALGEBRA_I Progressions (ENFORCE THAT NO Fall 2024 TEST AVAILABLE!)
...
# Exclude Fall 2024 ALGEBRA_I, GEOMETRY and ALGEBRA_II for good measure?
table(math.prog$BACKWARD[["2024_2025.2"]]$ALGEBRA_I.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "GEOMETRY.EOCT",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1])
...
GEOM <-
  math.prog$BACKWARD[["2024_2025.2"]]$GEOMETRY.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1 != "GEOMETRY.EOCT" | is.na(CONTENT_AREA_by_GRADE_PRIOR_YEAR.1)] #  Keep NA's for Fall to Fall checks
...
# table(math.prog$BACKWARD[["2024_2025.2"]]$GEOMETRY.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "ALGEBRA_I.EOCT",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1])  # Exclude  GEOMETRY, ALGEBRA_I and ALGEBRA_II
# table(math.prog$BACKWARD[["2024_2025.2"]]$GEOMETRY.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "ALGEBRA_II.EOCT",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1]) # Exclude  GEOMETRY, ALGEBRA_I and ALGEBRA_II
# table(math.prog$BACKWARD[["2024_2025.2"]]$GEOMETRY.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "MATHEMATICS.08",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1]) # Exclude  ALGEBRA_I

# math.prog$BACKWARD[["2024_2025.2"]]$GEOMETRY.EOCT[!is.na(CONTENT_AREA_by_GRADE_PRIOR_YEAR.1) & CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "ALGEBRA_II.EOCT", list(Total=sum(COUNT)), keyby=c("CONTENT_AREA_by_GRADE_PRIOR_YEAR.2")]
...
ALG2 <- math.prog$BACKWARD[["2024_2025.2"]]$ALGEBRA_II.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1 != "ALGEBRA_II.EOCT" | is.na(CONTENT_AREA_by_GRADE_PRIOR_YEAR.1)] #  Keep NA's for Fall to Fall checks
...
table(math.prog$BACKWARD[["2024_2025.2"]]$ALGEBRA_II.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "ALGEBRA_I.EOCT",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1]) # Exclude  GEOMETRY, ALGEBRA_I and ALGEBRA_II
table(math.prog$BACKWARD[["2024_2025.2"]]$ALGEBRA_II.EOCT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2 == "GEOMETRY.EOCT",  CONTENT_AREA_by_GRADE_PRIOR_YEAR.1])  # Exclude  GEOMETRY, ALGEBRA_I and ALGEBRA_II
...
names(ela.prog$BACKWARD[["2024_2025.2"]])

###   Spring to FallBlock  -  Establish configs for the SGP_NOTE variable
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.08"]$COUNT)   #  93024
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.09"]$COUNT)   #  8887 (repeaters)
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.09"]$COUNT)   #  4008
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.10"]$COUNT)   #  93   (repeaters)
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.10"]$COUNT)   #  0
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.11"]$COUNT)   #  0    (repeaters)


###   Spring to Spring  -  Establish configs for the SGP_NOTE variable
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.08[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.07"]$COUNT)   #  234624
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.08"]$COUNT)   #  93024
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.09[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.09"]$COUNT)   #  888   (repeaters)
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.08"]$COUNT)   #  1655  -  2 year skip
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.09"]$COUNT)   #  4008
sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10[CONTENT_AREA_by_GRADE_PRIOR_YEAR.1=="ELA.10"]$COUNT)   #  93    (repeaters)
# sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.10"]$COUNT)   #  X
# sum(ela.prog$BACKWARD[["2024_2025.2"]]$ELA.11[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="ELA.11"]$COUNT)   #  X (repeaters)
...
ELA <- ela.prog$BACKWARD[["2024_2025.2"]]$ELA.10
