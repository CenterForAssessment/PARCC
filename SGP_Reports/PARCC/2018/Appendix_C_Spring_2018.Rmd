---
title: "Appendix C to the Spring 2018 PARCC Student Growth Model Report:"
...
```{r, echo=FALSE, include=FALSE}
  ...
  knitr::opts_chunk$set(cache.path = "_cache/Appendix_C_Spring_2018", fig.path="../img/Appendices/Appendix_C_Spring_2018/")
  ...
  subject_order<-c("ELA", "MATHEMATICS",
	...
	prior.year <- c("2015_2016.2", "2016_2017.2", "2017_2018.1")
	current.year <- "2017_2018.2"
...
We see very few issues in all content areas and grades in the 2017 and 2018 PARCC grade level data.  Where minor ceilings appear in either years' data, the opposite year score distributions for these students are well distributed, lessening the concern for a growth ceiling effect.

Although ceiling effects are not widespread, there are two individual students who show potential problems in the grade level analyses.  The first is a student in the 11<sup>th</sup> grade ELA analysis that uses fall 2017 as the most recent prior.  This student scored near the HOSS in both tests and is a clear outlier in the scatterplot, and her estimated SGP is 51.  A similar student appears in the 8<sup>th</sup> grade Mathematics scatterplot, and this student's SGP estimate is 13.  It is not surprising that the SGP estimates of growth are questionable for extreme outliers in the data such as this.
...
```{r, echo=FALSE, include=FALSE, cache=TRUE, condDist_EOG, fig.height=2.5, fig.width=3}
	...
	condDistPlot(ca="ELA", g=10, prior.ca="2015_2016.2/ELA_8")
	condDistPlot(ca="ELA", g=10, prior.ca="2016_2017.2/ELA_9")
	condDistPlot(ca="ELA", g=11, prior.ca="2016_2017.2/ELA_10")
...
```{r, results="asis", echo=FALSE, ELA_Cond_Dists1}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-1.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-2.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-3.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-4.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-5.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-6.png"),
...
```{r, results="asis", echo=FALSE, ELA_Cond_Dists2}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-7.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-8.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-9.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-10.png"),
...
```{r, results="asis", echo=FALSE, Math_Cond_Dists1}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-11.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-12.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-13.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-14.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOG-15.png"),
			rows = 3, columns = 2, page.break= TRUE, pdf.width = 0.5,
...
Overall there is no evidence for concern of ceiling or floor effects in the PARCC EOCT analyses.  There are several cases that appear to be somewhat problematic in that students consistently scoring high receive lower than expected SGP estimates.  For example, the Algebra I cohort with Geometry as the most recent prior, the Geometry cohort with Algebra I prior and Algebra II with Mathematics Grade 8 and Fall 2017 Geometry priors.  In all cases, the students' SGPs are above 50 (i.e. above average), so they would not be flagged as having low growth^[Interestingly, the Ranked SIMEX SGP estimate for these same students are higher, which shows how the SIMEX correction can help in these cases].  This is likely not an adequate description of these students' growth given their consistently high achievement, and an individual (manual) correction may be required for these specific cases.

```{r, echo=FALSE, include=FALSE, cache=TRUE, condDist_EOC, fig.height=2.5, fig.width=3}
# table(long.data[YEAR==current.year & CONTENT_AREA=="GEOMETRY" & !is.na(as.numeric(SGP)), Most_Recent_Prior])

	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016_2017.2/MATHEMATICS_6")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016_2017.2/MATHEMATICS_7")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016_2017.2/MATHEMATICS_8")
	condDistPlot(ca="ALGEBRA_I", g="EOCT", prior.ca="2016_2017.2/GEOMETRY_EOCT")
	# max.data[CONTENT_AREA %in% "GEOMETRY" & SCALE_SCORE==HOSS_1 & Most_Recent_Prior=="2016_2017.2/ALGEBRA_II_EOCT"]

	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2015_2016.2/MATHEMATICS_8")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2016_2017.2/MATHEMATICS_8")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2015_2016.2/ALGEBRA_I_EOCT")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2016_2017.2/ALGEBRA_I_EOCT")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2017_2018.1/ALGEBRA_I_EOCT")
	condDistPlot(ca="GEOMETRY", g="EOCT", prior.ca="2016_2017.2/ALGEBRA_II_EOCT")

	condDistPlot(ca="ALGEBRA_II", g="EOCT", prior.ca="2016_2017.2/MATHEMATICS_8")
	condDistPlot(ca="ALGEBRA_II", g="EOCT", prior.ca="2016_2017.2/ALGEBRA_I_EOCT")
	condDistPlot(ca="ALGEBRA_II", g="EOCT", prior.ca="2016_2017.2/GEOMETRY_EOCT")
...
```{r, results="asis", echo=FALSE, Alg1_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-1.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-2.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-3.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-4.png"),
			page.break= TRUE, pdf.width = 0.5, rows = 2, columns = 2, 
...
```{r, results="asis", echo=FALSE, Geom_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-5.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-6.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-7.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-8.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-9.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-10.png"),
			page.break= TRUE, pdf.width = 0.5, rows = 3, columns = 2, 
...
```{r, results="asis", echo=FALSE, Alg2_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-11.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-12.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-13.png",
								"../img/Appendices/Appendix_C_Spring_2018/condDist_EOC-14.png"),
			page.break= TRUE, pdf.width = 0.5, rows = 2, columns = 2, 
...
The scatter plots in the previous section showed that there are no concerns for ceiling or floor effects in either the ELA or Mathematics assessments.  Figure C. 7 suggests that there are potential problems in the high school ELA tests and 8<sup>th</sup> grade Mathematics.  However, Figure C. 8 shows that potential ceiling issues do not effect the students that scored exactly the HOSS.  Only students scoring just below the HOSS have somewhat lower SGPs, but these growth estimates are still relatively high.  Figure C.8 does suggest that one student in Grade 8 ELA may be impacted by a minor floor effect with an unexpectedly high SGP estimate of 18.  This, however, is still a relatively low SGP that would likely still accurately flag this student as having low growth. 


```{r, results="asis", echo=FALSE, EOG_HOSS1}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOG-1.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOG-1.png"),
...
```{r, results="asis", echo=FALSE, EOG_HOSS2}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOG-2.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOG-2.png"),
			rows = 2, columns = 1, page.break= TRUE,
...
```{r, results="asis", echo=FALSE, EOC_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOC-1.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOC-1.png"),
...
```{r, results="asis", echo=FALSE, Alg1_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOC-2.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOC-2.png"),
...
```{r, results="asis", echo=FALSE, Geom_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOC-3.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOC-3.png"),
			rows = 2, columns = 1, page.break= TRUE,
			caption = "EOCT SGP distributions for the HOSS and LOSS scores by norm group: Geometry.")
```


The plots for the Algebra II progression with the Grade 8 Math prior is notable.  This progression can also be seen in Figure C.6 above.  Here the student who scored near the HOSS consecutively has an unexpectedly low SGP of 52.

```{r, results="asis", echo=FALSE, Alg2_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Spring_2018/HOSS_Box_EOC-4.png", "../img/Appendices/Appendix_C_Spring_2018/LOSS_Box_EOC-4.png"),
			rows = 2, columns = 1, page.break= TRUE,
