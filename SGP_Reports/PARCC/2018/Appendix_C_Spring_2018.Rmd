...
```{r, echo=FALSE, include=FALSE}
  ...
  knitr::opts_chunk$set(cache.path = "_cache/Appendix_C_Fall_2017", fig.path="../img/Appendices/Appendix_C_Fall_2017/")
  ...
  subject_order<-c("ELA",
	...
	prior.year <- c("2016_2017.2", "2017_2018.1")
	...
	condDistPlot <- function(ca, g, prior.ca = NULL) {
		...
		if (!is.null(prior.ca)) {
			tmp.prior.year <- paste(rev(strsplit(gsub("[.]1", "__Fall", (gsub("[.]2", "__Spring", strsplit(strsplit(prior.ca, "/")[[1]][1],
																	"_")[[1]][2]))), "__")[[1]]), collapse = " ")
...
```{r, results="asis", echo=FALSE, ELA_Cond_Dists1}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/condDist_EOG-1.png", "../img/Appendices/Appendix_C_Fall_2017/condDist_EOG-2.png"),
...
```{r, results="asis", echo=FALSE, ELA_Cond_Dists2}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/condDist_EOG-3.png", "../img/Appendices/Appendix_C_Fall_2017/condDist_EOG-4.png",
								"../img/Appendices/Appendix_C_Fall_2017/condDist_EOG-5.png"),
...
# table(long.data[YEAR==current.year & CONTENT_AREA=="ALGEBRA_II" & !is.na(SGP), Most_Recent_Prior])
...
```{r, results="asis", echo=FALSE, Alg1_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/condDist_EOC-1.png"),
			page.break= TRUE, pdf.width = 0.95, # rows = 2, columns = 2, 
...
```{r, results="asis", echo=FALSE, Geom_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/condDist_EOC-2.png"),
			page.break= TRUE, pdf.width = 0.95, # rows = 3, columns = 2, 
...
```{r, results="asis", echo=FALSE, Alg2_Cond_Dists}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/condDist_EOC-3.png",
								"../img/Appendices/Appendix_C_Fall_2017/condDist_EOC-4.png"),
			rows = 1, columns = 2, page.break= TRUE, pdf.width = 0.75,
...
```{r, results="asis", echo=FALSE, EOG_HOSS1}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOG-1.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOG-1.png"),
...
```{r, results="asis", echo=FALSE, EOG_HOSS2}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOG-2.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOG-2.png"),
			rows = 2, columns = 1, page.break= TRUE,
...
```{r, results="asis", echo=FALSE, EOC_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOC-1.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOC-1.png"),
...
```{r, results="asis", echo=FALSE, Alg1_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOC-2.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOC-2.png"),
...
```{r, results="asis", echo=FALSE, Geom_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOC-3.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOC-3.png"),
			rows = 2, columns = 1, page.break= TRUE,
...
```{r, results="asis", echo=FALSE, Alg2_HOSS}
		placeFigure(
			files = c("../img/Appendices/Appendix_C_Fall_2017/HOSS_Box_EOC-4.png", "../img/Appendices/Appendix_C_Fall_2017/LOSS_Box_EOC-4.png"),
			rows = 2, columns = 1, page.break= TRUE,
