...
date: July 31, 2018
abstract: "DRAFT REPORT - DO NOT CITE! <br></br> This report provides details about the PARCC consortium Student Growth Model methodology and presents a descriptive analysis of the 2018 SGP calculation process and results."
---
...
As an example, Figure `r getCounter("figure")+1` shows the results for 8<sup>th</sup> grade ELA as an example of good model fit.  Figure `r getCounter("figure")+2` demonstrates minor model misfit in the Integrated Math 2 analyses that uses Integrated Math 1 for its prior scores.
...
```{r, cache=TRUE, echo=FALSE, message=FALSE, include=FALSE, GOFplots}
  ...
  dat <- PARCC_SGP@Data[SGP_NORM_GROUP %in% "2016_2017.2/INTEGRATED_MATH_1_EOCT; 2017_2018.2/INTEGRATED_MATH_2_EOCT", 
  				 c("VALID_CASE", "CONTENT_AREA", "GRADE", "YEAR", "ID", "SGP", "SGP_SIMEX_RANKED", "SCALE_SCORE", "SCALE_SCORE_PRIOR", "SGP_NORM_GROUP"), with=FALSE]

	gofSGP(dat, state="PARCC", years='2017_2018.2', content_areas='INTEGRATED_MATH_2', use.sgp="SGP", output.format="PNG")
	gofSGP(dat, state="PARCC", years='2017_2018.2', content_areas='INTEGRATED_MATH_2', use.sgp="SGP_SIMEX_RANKED", output.format="PNG")

	###  HAVE TO RENAME THE GoFit PLOTS CONTAINING A "." IN NAME !!!
	invisible(file.rename(
		"Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2/2017_2018.2_INTEGRATED_MATH_2_EOCT;2016_2017.2_INTEGRATED_MATH_1_EOCT.png",
		"Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2/2016_2017_2_INTEGRATED_MATH_2_EOCT;2015_2016_2_INTEGRATED_MATH_1_EOCT.png"))
	invisible(file.rename(
		"Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2.RANKED_SIMEX/2017_2018.2_INTEGRATED_MATH_2_EOCT;2016_2017.2_INTEGRATED_MATH_1_EOCT.png",
		"Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2.RANKED_SIMEX/2016_2017_2_INTEGRATED_MATH_2_EOCT;2015_2016_2_INTEGRATED_MATH_1_EOCT.png"))
...
The model fit plots for the unadjusted, cohort-referenced model results in all subjects are excellent with few exceptions (see Appendix A for all model fit plots).  Figure `r getCounter("figure")+1` displays the 8<sup>th</sup> grade ELA model as an exemplar of model fit, and Figure `r getCounter("figure")+2` is an Integrated Math 2 progression which exemplifies the extent to which model misfit is present in the PARCC SGP analyses.
...
```{r, results="asis", echo=FALSE, IntMath2_GoF_Cohort}
		placeFigure(page.break= TRUE,
			files = "../img/Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2/2016_2017_2_INTEGRATED_MATH_2_EOCT;2015_2016_2_INTEGRATED_MATH_1_EOCT.png",
...
```{r, results="asis", echo=FALSE, IntMath2_GoF_RSIMEX}
		placeFigure(page.break= TRUE,
			files = "../img/Goodness_of_Fit/INTEGRATED_MATH_2.2017_2018.2.RANKED_SIMEX/2016_2017_2_INTEGRATED_MATH_2_EOCT;2015_2016_2_INTEGRATED_MATH_1_EOCT.png",
