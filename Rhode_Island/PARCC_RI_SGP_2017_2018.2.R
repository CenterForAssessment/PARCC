#################################################################################
###                                                                           ###
###     SGP analysis script for PARCC Rhode_Island - Spring 2018 Analyses     ###
###                                                                           ###
#################################################################################
...
Rhode_Island_SGP <- abcSGP(
		state="RI",
		sgp_object=fetchPARCC(state="RI", parcc.db = "../PARCC/Data/PARCC_Data_LONG.sqlite", prior.years=c("2016_2", "2017_1", "2017_2", "2018_1"), current.year="2018_2", fields="*")[GRADE %in% c(3:9, "EOCT") & CONTENT_AREA %in% RI.CA],
...
### Save results
if (sgp.test) {
	save(Rhode_Island_SGP, file="./Data/SIM/Rhode_Island_SGP-Test_PARCC_2017_2018.2.Rdata")
} else save(Rhode_Island_SGP, file="./Data/Archive/2017_2018.2/Rhode_Island_SGP.Rdata")
...
table(Rhode_Island_SGP@Data[YEAR=="2017_2018.2" & !is.na(SGP), GRADE, CONTENT_AREA])
table(Rhode_Island_SGP@Data[YEAR=="2017_2018.2" & !is.na(SGP) & CONTENT_AREA=="ELA", GRADE])
