...
State_LONG_Data <- Washington_DC_SGP_LONG_Data_2018_2019.2[grep("_SS", CONTENT_AREA, invert =TRUE),]
...
FINAL_LONG_Data[, as.list(summary(as.numeric(StudentGrowthPercentileComparedtoState))), keyby="TestCode"]
...
FINAL_LONG_Data[TestCode=="GEO01" & SGPPreviousTestCodeState1Prior=="MAT08", as.list(summary(as.numeric(StudentGrowthPercentileComparedtoState))), keyby="StateAbbreviation"]
...
FINAL_LONG_Data[TestCode=="ELA10" & SGPPreviousTestCodeState1Prior=="ELA09" & StateAbbreviation %in% c("MD", "NJ", "NM"), as.list(summary(as.numeric(StudentGrowthPercentileComparedtoState))), keyby="StateAbbreviation"]
