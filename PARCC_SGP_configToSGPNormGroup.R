...
PARCC_2016_2017.2.config <- c(
	ELA.2016_2017.2.config, ELA_SS.2016_2017.2.config,
	MATHEMATICS.2016_2017.2.config, ALGEBRA_I.2016_2017.2.config, GEOMETRY.2016_2017.2.config, ALGEBRA_II.2016_2017.2.config,
	INTEGRATED_MATH_1.2016_2017.2.config, INTEGRATED_MATH_2.2016_2017.2.config, INTEGRATED_MATH_3.2016_2017.2.config,
	MATHEMATICS_SS.2016_2017.2.config, ALGEBRA_I_SS.2016_2017.2.config, GEOMETRY_SS.2016_2017.2.config, ALGEBRA_II_SS.2016_2017.2.config,
	INTEGRATED_MATH_1_SS.2016_2017.2.config, INTEGRATED_MATH_2_SS.2016_2017.2.config, INTEGRATED_MATH_3_SS.2016_2017.2.config)
...
tmp.configToNormGroup <- lapply(PARCC_2016_2017.2.config, configToSGPNormGroup)
PARCC_SGP_Norm_Group_Preference_2017.2 <- data.table(
					YEAR="2016_2017.2", rbindlist(tmp.configToNormGroup))
...
PARCC_SGP_Norm_Group_Preference <- rbind(PARCC_SGP_Norm_Group_Preference_2016, PARCC_SGP_Norm_Group_Preference_2017.1, PARCC_SGP_Norm_Group_Preference_2017.2)
