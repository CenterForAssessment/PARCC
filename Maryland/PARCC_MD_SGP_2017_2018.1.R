...
###   Create Fall 2017 Archive for MD
...
if (sgp.test) {
	save(Maryland_SGP, file="./Data/SIM/Maryland_SGP-Test_PARCC_2017_2018.1.Rdata")
} else save(Maryland_SGP, file="./Data/Archive/2017_2018.1/Maryland_SGP.Rdata")
