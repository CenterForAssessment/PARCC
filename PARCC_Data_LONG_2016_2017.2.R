...
PARCC_Data_LONG_2016_2017.2 <- rbindlist(list(read.parcc("BI", "D20170214"),
...
PARCC_Data_LONG_2016_2017.2 <- PARCC_Data_LONG_2016_2017.2[, parcc.var.names, with=FALSE]
...
levels(PARCC_Data_LONG_2016_2017.2$CONTENT_AREA) <- c("ALGEBRA_I", "ALGEBRA_II", rep("ELA", 3), "GEOMETRY")
