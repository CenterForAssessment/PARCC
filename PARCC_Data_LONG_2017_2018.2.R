################################################################################
###                                                                          ###
###              Create PARCC LONG Data for Spring 2018 Analyses             ###
###                                                                          ###
################################################################################
...
####  ID
setnames(PARCC_Data_LONG_2017_2018.2, "PARCCStudentIdentifier", "ID")
...
####  GRADE from TestCode
PARCC_Data_LONG_2017_2018.2[, GRADE := gsub("ELA|MAT", "", TestCode)]
PARCC_Data_LONG_2017_2018.2[, GRADE := as.character(as.numeric(GRADE))]
PARCC_Data_LONG_2017_2018.2[which(is.na(GRADE)), GRADE := "EOCT"]
PARCC_Data_LONG_2017_2018.2[, GRADE := as.character(GRADE)]
# table(PARCC_Data_LONG_2017_2018.2[, GRADE, TestCode])
...
PARCC_Data_LONG_SS <- copy(PARCC_Data_LONG_2017_2018.2)
...
setkey(PARCC_Data_LONG_2017_2018.2, CONTENT_AREA, GRADE)
...
setnames(PARCC_Data_LONG_2017_2018.2, c("IRTTheta", "SummativeScaleScore", "SummativeCSEM"), c("SCALE_SCORE", "SCALE_SCORE_ACTUAL", "SCALE_SCORE_CSEM_ACTUAL"))


####  Stack Theta and SS Data
PARCC_Data_LONG_2017_2018.2 <- rbindlist(list(PARCC_Data_LONG_2017_2018.2, PARCC_Data_LONG_SS), fill=TRUE)
PARCC_Data_LONG_2017_2018.2[, CONTENT_AREA := as.character(CONTENT_AREA)]

####  Valid Cases
PARCC_Data_LONG_2017_2018.2[, VALID_CASE := "VALID_CASE"]

####  Invalidate Cases with missing IDs - 0 invalid in FINAL data
PARCC_Data_LONG_2017_2018.2[which(is.na(ID)), VALID_CASE := "INVALID_CASE"]

####  ACHIEVEMENT_LEVEL
PARCC_Data_LONG_2017_2018.2 <- SGP:::getAchievementLevel(PARCC_Data_LONG_2017_2018.2, state="PARCC")

table(PARCC_Data_LONG_2017_2018.2[, ACHIEVEMENT_LEVEL, CONTENT_AREA], exclude=NULL)
# gl <- c("ELA", "ELA_SS", "MATHEMATICS", "MATHEMATICS_SS")
# PARCC_Data_LONG_2017_2018.2[!CONTENT_AREA %in% gl, list(MAX= max(as.numeric(SCALE_SCORE))), keyby=c("CONTENT_AREA", "ACHIEVEMENT_LEVEL")] # summary(as.numeric(SCALE_SCORE))
# PARCC_Data_LONG_2017_2018.2[CONTENT_AREA == "ELA", list(MIN= min(as.numeric(SCALE_SCORE))), keyby=c("CONTENT_AREA", "ACHIEVEMENT_LEVEL", "GRADE")]
...
PARCC_Data_LONG_2017_2018.2[, EXACT_DUPLICATE := as.numeric(NA)]

setkey(PARCC_Data_LONG_2017_2018.2, VALID_CASE, YEAR, CONTENT_AREA, GRADE, ID, SCALE_SCORE_ACTUAL, SCALE_SCORE)
...
setkeyv(dups, key(PARCC_Data_LONG_2017_2018.2))
PARCC_Data_LONG_2017_2018.2[which(duplicated(PARCC_Data_LONG_2017_2018.2, by=key(PARCC_Data_LONG_2017_2018.2)))-1, EXACT_DUPLICATE := 1]
...
# setkey(PARCC_Data_LONG_2017_2018.2, VALID_CASE, YEAR, CONTENT_AREA, ID, SCALE_SCORE)
# setkey(PARCC_Data_LONG_2017_2018.2, VALID_CASE, YEAR, CONTENT_AREA, ID)
### PARCC_Data_LONG_2017_2018.2[which(duplicated(PARCC_Data_LONG_2017_2018.2, by=key(PARCC_Data_LONG_2017_2018.2)))-1, VALID_CASE := "INVALID_CASE"]
...
setcolorder(PARCC_Data_LONG_2017_2018.2, c(db.order, "ACHIEVEMENT_LEVEL", "EXACT_DUPLICATE")) # To match original var order

PARCC_Data_LONG_2017_2018.2[, GRADE := as.character(GRADE)]
PARCC_Data_LONG_2017_2018.2[, SCALE_SCORE := as.numeric(SCALE_SCORE)]
PARCC_Data_LONG_2017_2018.2[, SCALE_SCORE_CSEM := as.numeric(SCALE_SCORE_CSEM)]
