...
ELA.2017_2018.2.config[[1]]$sgp.grade.sequences <- list(c("3", "4"), c("3", "4", "5"), c("4", "5", "6"), c("5", "6", "7"), c("6", "7", "8"), c("7", "8", "9"), c("8", "9", "10"))
ELA_SS.2017_2018.2.config[[1]]$sgp.grade.sequences <- list(c("3", "4"), c("3", "4", "5"), c("4", "5", "6"), c("5", "6", "7"), c("6", "7", "8"), c("7", "8", "9"), c("8", "9", "10"))
...
PARCC_2017_2018.2.config <- PARCC_2017_2018.2.config[!sapply(PARCC_2017_2018.2.config, function(f) any(grepl("2016_2017.1", f)))]
...
Washington_DC_SGP <- abcSGP(
		state="DC",
		sgp_object=fetchPARCC(state="DC", parcc.db = "../PARCC/Data/PARCC_Data_LONG.sqlite", prior.years=c("2016_2", "2017_1", "2017_2", "2018_1"), current.year="2018_2", fields="*")[GRADE %in% c(3:8, 10, "EOCT") & CONTENT_AREA %in% DC.CA],
