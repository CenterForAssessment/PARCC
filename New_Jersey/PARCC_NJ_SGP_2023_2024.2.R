...
###############################################################################
###                                                                         ###
###            New_Jersey 2024 (Cohort and Baseline) SGP Analyses           ###
###                                                                         ###
###############################################################################
...
load("./Data/Archive/2023_2024.2/New_Jersey_Data_LONG_2023_2024.2.Rdata")
...
New_Jersey_SGP@Version$session_platform <- list("2024" = session_platform)
New_Jersey_SGP@Version$attached_pkgs <- list("2024" = attached_pkgs)
New_Jersey_SGP@Version$namespace_pkgs<-  list("2024" = namespace_pkgs)

save(New_Jersey_SGP, file = "./Data/Archive/2023_2024.2/New_Jersey_SGP.Rdata")
...
#' baseline-referenced SGPs were calculated concurrently for the 2024 New Jersey
