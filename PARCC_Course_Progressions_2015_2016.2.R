...
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="MATHEMATICS.06"]$COUNT) # 12879 12884
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="MATHEMATICS.07"]$COUNT) # 69301 69317
sum(math.prog$BACKWARD[['2015_2016.2']]$ALGEBRA_I.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="MATHEMATICS.08"]$COUNT) # 172247 172226
...
sum(math.prog$BACKWARD[['2015_2016.2']]$GEOMETRY.CT[CONTENT_AREA_by_GRADE_PRIOR_YEAR.2=="MATHEMATICS.08"]$COUNT) # 5955 5934
