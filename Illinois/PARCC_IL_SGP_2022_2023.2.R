...
#' baseline-referenced SGPs were calculated concurrently for the 2023 Illinois
...
#'
#' The 2023 SGP analyses were conducted at both the consortium and member/state level.
...
#' The 2023 configuration scripts were loaded and combined into a single list
...
#' function to ***a)*** format the the cleaned spring 2023 data according to the `SGP`
