################################################################################
###                                                                          ###
###   Illinois Learning Loss Analyses -- 2019 Baseline Growth Projections    ###
###                                                                          ###
################################################################################
...
Illinois_2018_2019_BASELINE_PROJECTIONS_CONFIG <- c(
...
Illinois_SGP <- abcSGP(
        ...
        sgp.config = Illinois_2018_2019_BASELINE_PROJECTIONS_CONFIG,
