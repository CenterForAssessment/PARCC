...
Illinois_SGP_LONG_Data_2016_2017.2[, SGP_TARGET_3_YEAR_CONTENT_AREA := as.character(NA)]
Illinois_SGP_LONG_Data_2016_2017.2[!is.na(SGP_TARGET_3_YEAR), SGP_TARGET_3_YEAR_CONTENT_AREA := CONTENT_AREA]
...
State_LONG_Data <- rbindlist(list(
  Colorado_SGP_LONG_Data_2016_2017.2, Illinois_SGP_LONG_Data_2016_2017.2,
  Maryland_SGP_LONG_Data_2016_2017.2, New_Jersey_SGP_LONG_Data_2016_2017.2,
  New_Mexico_SGP_LONG_Data_2016_2017.2, Rhode_Island_SGP_LONG_Data_2016_2017.2,
  Washington_DC_SGP_LONG_Data_2016_2017.2, Bureau_Indian_Affairs_SGP_LONG_Data_2016_2017.2), fill=TRUE)
...
levels(State_LONG_Data$CONTENT_AREA_1PRIOR) <- c(NA, "ALG01", "ALG02", "ELA", "GEO01", "MAT1I", "MAT2I", "MAT3I", "MAT")
...
levels(State_LONG_Data$SGPTargetTestCodeState) <- c("ALG01", "ALG02", "ELA", "GEO01", "MAT1I", "MAT")
...
for (abv in unique(FINAL_LONG_Data$StateAbbreviation)) {
  if (abv=="BI") tmp.state <- "Bureau Indian Affairs" else tmp.state <- SGP:::getStateAbbreviation(abv, type="state")
	fname <- paste0("PARCC_", abv, "_2016-2017_Spring_SGP-Results_", format(Sys.Date(), format="%Y%m%d"), ".csv")
