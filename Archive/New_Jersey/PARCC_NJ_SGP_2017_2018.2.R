#################################################################################
###                                                                           ###
###      SGP analysis script for PARCC New_Jersey - Spring 2018 Analyses      ###
###                                                                           ###
#################################################################################
...
New_Jersey_SGP <- abcSGP(
		state="NJ",
		sgp_object=fetchPARCC(state="NJ", parcc.db = "../PARCC/Data/PARCC_Data_LONG.sqlite", prior.years=c("2016_2", "2017_1", "2017_2", "2018_1"), current.year="2018_2", fields="*")[CONTENT_AREA %in% NJ.CA],
...
table(New_Jersey_SGP@Data[YEAR=="2017_2018.2" & !is.na(SGP), GRADE, CONTENT_AREA])
table(New_Jersey_SGP@Data[YEAR=="2017_2018.2" & !is.na(SGP) & CONTENT_AREA=="ELA", GRADE])
