#####################################################################################
###                                                                               ###
###    SGP Configurations code for Spring 2019  Grade Level ELA - SCALE SCORES    ###
###                                                                               ###
#####################################################################################

ELA_SS.2018_2019.2.config <- list(
	ELA_SS.2018_2019.2 = list(
	...
	ELA_SS.2018_2019.2 = list(  #  Skip year progression for Washington DC
	...
	ELA_SS.2018_2019.2 = list(  #  Fall - Spring
		sgp.content.areas=rep("ELA_SS", 2),
