...
cat("#########################################\n", file="PARCC_Output_Validation_2016_2017.2.out")
cat("######### PARCC OUTPUT VALIDATION #######\n", file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)
cat("#########################################\n", file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)
...
for (state in tmp.states) {
    tmp.ORIGINAL<-read.parcc(state, "2016-2017_SGPO_D2017062", "ORIGINAL")
    tmp.OUTPUT <- read.parcc(state, "2016-2017_Spring_SGP-Results_20170709")
    ...
    cat(paste("\n### Test for Identical PARCCStudentIdentifier in BASE and OUTPUT files:", tmp.tf), file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)

    tmp.sgp.state <- paste(as.character(summary(as.numeric(tmp.OUTPUT$StudentGrowthPercentileComparedtoState))), collapse=" ")
    cat(paste("\n### Test of StudentGrowthPercentileComparedtoState:", tmp.sgp.state), file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)

    tmp.sgp.parcc <- paste(as.character(summary(as.numeric(tmp.OUTPUT$StudentGrowthPercentileComparedtoPARCC))), collapse=" ")
    cat(paste("\n### Test of StudentGrowthPercentileComparedtoPARCC:", tmp.sgp.parcc), file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)

    tmp.target.state <- paste(as.character(summary(as.numeric(tmp.OUTPUT$SGPTargetState))), collapse=" ")
    cat(paste("\n### Test of SGPTargetState:", tmp.target.state), file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)

    tmp.target.parcc <- paste(as.character(summary(as.numeric(tmp.OUTPUT$SGPTargetPARCC))), collapse=" ")
    cat(paste("\n### Test of SGPTargetPARCC:", tmp.target.parcc), file="PARCC_Output_Validation_2016_2017.2.out", append=TRUE)
    ...
    capture.output(tmp.simex.state, file = "PARCC_Output_Validation_2016_2017.2.out", append=TRUE)
    ...
    capture.output(tmp.simex.parcc, file = "PARCC_Output_Validation_2016_2017.2.out", append=TRUE)
